...
namespace MindmapApp.ViewModels
{
    public class NodeViewModel : BaseViewModel
    {
        ...
        // 🔥 THÊM MỚI: Trạng thái Khóa bởi người khác
        private bool _isLockedByRemote;
        public bool IsLockedByRemote
        {
            get => _isLockedByRemote;
            set => SetProperty(ref _isLockedByRemote, value);
        }

        private string? _lockedByEmail;
        public string? LockedByEmail
        {
            get => _lockedByEmail;
            set => SetProperty(ref _lockedByEmail, value);
        }

        private string? _remoteLockColor;
        public string? RemoteLockColor
        {
            get => _remoteLockColor;
            set => SetProperty(ref _remoteLockColor, value);
        }
        ...
        private string CreateDefaultXaml(string text)
        {
            ...
            return $"<FlowDocument xmlns=\"http://schemas.microsoft.com/winfx/2006/xaml/presentation\" PagePadding=\"0\"><Paragraph TextAlignment=\"Center\"><Run>{safeText}</Run></Paragraph></FlowDocument>";
        }
        ...
        public bool IsBold
        {
            ...
            set
            {
                ...
                {
                    _model.IsBold = value;
                    _model.FontWeight = value ? "Bold" : "Normal";
                    OnPropertyChanged();
